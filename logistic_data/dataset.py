...
class LogisticDataset(Dataset):
    def __init__(self, root, filename, test=False, transform=None, pre_transform=None):
        ...
        super(LogisticDataset, self).__init__(root, transform, pre_transform)
    ...
    def process(self):
        ...
        read_file="./dizionario_logistica_azioni_ohe.txt"
        ...
        for p in self.piani:
            ...
            for lista in lista_splittati:
                if len(lista)==3:
                    ...
                    lista_edg_f.append(torch.tensor([1,0]))
                    lista_adj.append([ dict_graph_per_adiacenza[lista[1]],  dict_graph_per_adiacenza[lista[2]] ] )
                    lista_edg_f.append(torch.tensor([0,1]))
                else:
                    print("trovata lista di len != 3") 
                    break 
            #obj=codifica
